...
//CSCI 2421 Fall 2013
//node.h
//node template class declaration, linked-list toolkit declaration from textbook
//to be included with node.cpp
...
private: 
	...
	template <typename value_type>
    std::size_t list_length(const node<value_type>* head_ptr); 
    template <typename value_type>
    ...
    template <typename value_type>
	const node<value_type>* list_search 
	(const node<value_type>* head_ptr, const value_type& target); 
    template <typename value_type>
	node<value_type>* list_locate(node<value_type>* head_ptr, std::size_t position); 
    template <typename value_type>
	const node<value_type>* list_locate(const node<value_type>* head_ptr, std::size_t position); 
	template <typename value_type>
